  ...
  return (
    ...
    >
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              <li key={item.path}>
                <Link
                  to={item.path}
                  className={`flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${isActive(item.path)
      ...
      <div className="p-3 border-t border-[#2A3441] space-y-2">
        ...
        <Link
          to="/settings"
          className={`flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${isActive('/settings')
              ? 'bg-[#00E0FF] text-[#0F1419]'
              : 'text-gray-300 hover:bg-[#2A3441] hover:text-white'
            } ${isCollapsed ? 'justify-center' : ''}`}
        ...
        <Link
          to="/help"
          className={`flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${isActive('/help')
              ? 'bg-[#00E0FF] text-[#0F1419]'
              : 'text-gray-300 hover:bg-[#2A3441] hover:text-white'
            } ${isCollapsed ? 'justify-center' : ''}`}
